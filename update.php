...
<body>
    ...
    <div class="features1" enctype="multipart/form-data">
        ...
        <form action="actions/update.php" method="post" id='form'>
            <input type="hidden" name="id" value="<?= $conference['id'] ?>">
            <input type="text" name="title" class="form-control" placeholder="Title" required="" id="id_title" value="<?= $conference['title'] ?>"><br>
            <input type="date" name="date" class="form-control" placeholder="Date" required="" id="id_date" value="<?= $conference['date'] ?>"><br>
            <input type="text" id="latclicked" class="form-control" id="id_lat" name="lat" value="<?= $conference['latitude'] ?>" placeholder="Latitude">
            <input type="text" id="longclicked" class="form-control" id="id_lng" name="lng" value="<?= $conference['longitude'] ?>" placeholder="Longitude">
            ...
            <select name="country" class="form-control" id="id_country" placeholder="Country">
            ...
            <button class="button2 button-new" type="submit">Edit</button>
